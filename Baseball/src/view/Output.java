...
public class Output extends ViewMain {
...
//			if (type1 == 1) {
			OutputReset();
				...
				ArrayList<BaseballDto> b11 = (ArrayList<BaseballDto>) request.get("listd11");
				seat11[0][0] = "행＼열   ";
				seat11[1][0] = "1행      ";
				seat11[2][0] = "2행      ";
				seat11[3][0] = "3행      ";
...
//				OutputReset();
				...
				ArrayList<BaseballDto> b12 = (ArrayList<BaseballDto>) request.get("listd12");
				seat12[0][0] = "행＼열   ";
				seat12[1][0] = "1행      ";
				seat12[2][0] = "2행      ";
				seat12[3][0] = "3행      ";
...
//				OutputReset();
				...
				System.out.println("\n");
				ArrayList<BaseballDto> b13 = (ArrayList<BaseballDto>) request.get("listd13");
				seat13[0][0] = "행＼열   ";
				seat13[1][0] = "1행      ";
				seat13[2][0] = "2행      ";
				seat13[3][0] = "3행      ";
...
//			if (type2 == 1) {
				...
				System.out.println("\n");
				ArrayList<BaseballDto> b21 = (ArrayList<BaseballDto>) request.get("listd21");
				seat21[0][0] = "행＼열   ";
				seat21[1][0] = "1행      ";
				seat21[2][0] = "2행      ";
				seat21[3][0] = "3행      ";
...
//				OutputReset();
				...
				System.out.println("\n");
				ArrayList<BaseballDto> b22 = (ArrayList<BaseballDto>) request.get("listd22");
				seat22[0][0] = "행＼열   ";
				seat22[1][0] = "1행      ";
				seat22[2][0] = "2행      ";
				seat22[3][0] = "3행      ";
...
//				OutputReset();
				...
				System.out.println("<<<외야석>>>");
				System.out.println("\n");
				ArrayList<BaseballDto> b23 = (ArrayList<BaseballDto>) request.get("listd23");
				seat23[0][0] = "행＼열   ";
				seat23[1][0] = "1행      ";
				seat23[2][0] = "2행      ";
				seat23[3][0] = "3행      ";
...
//			if (type3 == 1) {
				...
				ArrayList<BaseballDto> b31 = (ArrayList<BaseballDto>) request.get("listd31");
				seat31[0][0] = "행＼열   ";
				seat31[1][0] = "1행      ";
				seat31[2][0] = "2행      ";
				seat31[3][0] = "3행      ";
...
//				OutputReset();
				...
				System.out.println("\n");
				ArrayList<BaseballDto> b32 = (ArrayList<BaseballDto>) request.get("listd32");
				seat32[0][0] = "행＼열   ";
				seat32[1][0] = "1행      ";
				seat32[2][0] = "2행      ";
				seat32[3][0] = "3행      ";
...
//				OutputReset();
				...
				System.out.println("\n");
				ArrayList<BaseballDto> b33 = (ArrayList<BaseballDto>) request.get("listd33");
				seat33[0][0] = "행＼열   ";
				seat33[1][0] = "1행      ";
				seat33[2][0] = "2행      ";
				seat33[3][0] = "3행      ";
